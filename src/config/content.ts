...
export const config = {
  ...
  galerie: {
    ...
    photos: [
      { src: '/b1.jpeg', legende: 'Sous le soleil',  },
      { src: '/b2.jpeg', legende: 'En mode ...',  },
      { src: '/b3.jpeg', legende: 'Manequin', },
      { src: '/b4.jpeg', legende: 'After Party',  },
      { src: '/b5.jpeg', legende: 'Douceur',  },
      { src: '/b6.jpeg', legende: 'Miss Bérénice',  },
      { src: '/b7.jpeg', legende: 'After Party', },
      { src: '/b8.jpeg', legende: 'Azimavi', },
      { src: '/b9.jpeg', legende: 'Évasion', },
    ],
  },
